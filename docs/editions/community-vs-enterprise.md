...
| [Storage classes](/docs/storage/storage-classes) — volumes on the disks you mount (bare metal, dedicated hosts) | 2 classes, `default` included | ✓ unlimited |
